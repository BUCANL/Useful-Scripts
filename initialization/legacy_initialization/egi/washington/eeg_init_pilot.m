function eeg_init_pilot(EEG,infname)
...
outfpath=['sub-p',subid,'/ses-',agelab,'/eeg/'];
...
outfname=['sub-p',subid,'_ses-',agelab,'_task-',tasklab,'_eeg.set'];

if strcmp(n(1:2),'p0');
    outfname = ['sub-p',subid,'_ses-',agelab,'_task-',tasklab,'_eeg_',n(1:3),'.set'];
end

if strcmp(n(end-5:end-3),'eeg');
    outfname = ['sub-p',subid,'_ses-',agelab,'_task-',tasklab,'_eeg_p',n(end-1:end),'.set'];
end
